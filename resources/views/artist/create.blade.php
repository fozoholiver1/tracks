                ...
                <div class="card-body">
                    <form method="POST" action="/a" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="artist_name" type="text" class="form-control @error('artist_name') is-invalid @enderror" name="artist_name" value="{{ old('artist_name') }}" required autocomplete="artist_name" autofocus>
